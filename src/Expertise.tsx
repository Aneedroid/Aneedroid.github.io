...
const skills = [
  {
    ...
    skills: ['React', 'TypeScript', 'Next.js', 'Material UI', 'Tailwind CSS', 'Framer Motion', 'Redux', 'HTML5/CSS3'],
  },
  {
    title: 'Backend',
  ...
  },
  {
    ...
    skills: ['Git', 'Docker', 'AWS', 'CI/CD', 'Linux', 'Jest', 'Webpack', 'Vite'],
  },
  {
    title: 'Gen AI',
    description: 'Leveraging LLMs and generative models to build intelligent features and automated workflows.',
    skills: ['OpenAI', 'LangChain', 'Vector DBs', 'RAG', 'Hugging Face', 'Prompt Engineering'],
  },
];

const Expertise = ({ pattern }: { pattern: 'squares' | 'vertices' }) => {
